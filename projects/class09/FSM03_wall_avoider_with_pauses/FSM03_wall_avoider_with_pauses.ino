...
void robot_control()
{
	...
	switch(run_state)
	{
		case 0:
			stop();	
			if(timer3 >= PAUSE_TIME)
			{ // make a decision and leave state
				if(distance > 20)
				{
					run_state = 1;
				}
