...
/*
	...
	If after adding a substantial amount of code our loop time
	changes to 50us... then this debounce time will double.
	
	Conclusion: this type of debounce is not consistent and therefore we should avoid
	using it since it does not reflect a college level understanding of embedded systems.
*/
